$(function(){
	...
	$('#g1-paySuccess-payment-details').click(function(){
		if($('#g1-paySuccess-payment-details-img').attr("src")==_paymentImg){
			...
			$('#g1-paySuccess-payment-details-img').attr("src","../../public/img/icon/triangle-orange-2.png");
		}else{
			$('#g1-paySuccess-payment-details-content').hide();
			$('#g1-paySuccess-payment-details-img').attr("src","../../public/img/icon/triangle-orange-1.png");
		}
	...
	$('.g1-paySuccess-comment-container-content-right-xing').click(function(){		
		$(this).attr("src","../../public/img/other/g1-comment3.png");
		$(this).prevAll().attr("src","../../public/img/other/g1-comment3.png");
		$(this).nextAll().attr("src","../../public/img/other/g1-comment2.png");
	});
